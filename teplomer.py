...
while True:
    ...
    if __name__ == '__main__':  
        ...
        if(((t.minute%1) == 0) and (t.second == 0)):
            ...
            if((type(nova_teplota) == str) or (type(nova_teplota) == float)):
                ...
                if((t.hour >= 6) and (t.hour <= 22)):
                    ...
                    if((t.minute == 0) and (t.second == 0)):
                        ...
                        # Upozornění o odeslání notifikace do telefonu
                        if(t.hour < 10 and t.minute < 10):
                            print("- 0%s:0%s - Zpráva byla odeslána" % (t.hour, t.minute))
                        elif(t.hour < 10):
                            print("- 0%s:%s - Zpráva byla odeslána" % (t.hour, t.minute))
                        elif(t.minute < 10):
                            print("- %s:0%s - Zpráva byla odeslána" % (t.hour, t.minute))
                        else:
                            print("- %s:%s - Zpráva byla odeslána" % (t.hour, t.minute))
                ...
                print("%s:%s - - - %s je typ %s" % (t.hour, t.minute, nova_teplota, type(nova_teplota)))
